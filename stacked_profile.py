...
plt.plot(pm_SIDM2h.r,pm_SIDM2h.GT2h,'C4:',label='q2h_gt = '+str(np.round(pm_SIDM2h.q2h_gx,2)))
...
plt.plot(pm_DM2h.r,pm_DM2h.GT1h,'C7--',label='q1h_gt = '+str(np.round(pm_DM2h.q1h_gx,2)))
plt.plot(pm_DM2h.r,pm_DM2h.GT2h,'C7:',label='q2h_gt = '+str(np.round(pm_DM2h.q2h_gx,2)))
